<template>
    <div>
        <Myitem v-for="(v,i) in arr" :key="i" :title="v.title" :url="v.url" :linkTo="v.linkTo"></Myitem>
    </div>
</template>
<script>
import Myitem from '../order/myitem'
export default {
    components:{
        Myitem
    },
    data(){
        return {
            arr:[
                {title:"盒马X会员",url:"../../../static/no_orderimg/img/5.png",linkTo:"/#"},
